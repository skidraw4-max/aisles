...
/**
 * Lounge 본문 + 하단 Source: Lobsters 및 원문·토론 링크.
 */
export function formatLobstersPostBody(
  originalUrl: string,
  lobstersDiscussionUrl: string,
...
- Source: Lobsters
- 토론(Lobsters): [lobste.rs](${lobstersDiscussionUrl})
- 원문: [링크 열기](${originalUrl})

---

출처: Lobsters · [원문 링크](${originalUrl})`;
